...
module vnet './modules/vnet-module/vnet.bicep' = {
  name: 'vnetDeploy'
  params: {
...
module workSpace './modules/workspace-module/workspace.bicep' = {
...
module aks './modules/aks-module/aks.bicep' = {
  name: 'aksDeploy'
  params: {
    location: location
    prefix: prefix
    ...
    tags: tags
    logAnalyticsWork: 'workSpaceDeploy'
  }
...
module registry './modules/acr-module/registry.bicep' = {
  name: 'registryDeploy'
  params: {
    location: location
